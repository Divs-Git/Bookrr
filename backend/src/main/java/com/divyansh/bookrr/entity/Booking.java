package com.divyansh.bookrr.entity;
...
public class Booking {
    ...
    @Min(value = 1, message = "Number of adults should not be less than 0")
    private int numOfAdults;

    @Min(value = 1, message = "Number of children should not be less than 0")
